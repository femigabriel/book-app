...
export const StorybookIntro = ({ onNextClick, onBackClick }: Props) => {
  return (
    <div className="readBook w-full h-screen overflow-hidden">
      ...
      <div className="text-center">
        ...
        <div className="lg:pt-10 text-[1em] lg:w-[723px] text-left">
          <p className="leading-9">
            Charlie cares about other people and how they feel. She doesn’t like
            it when people are hurt or upset.
            <br />
            When she notices that a person feels bad, she tries to help. Charlie
            believes that everyone deserves respect:
            <span className="text-[#9B59B6]">
              Charlie has good Relationship Skills.
            </span>
            <br />
            Charlie is able to tell her family and her friends how she feels. She
            also listens to what they have to say. <br />
